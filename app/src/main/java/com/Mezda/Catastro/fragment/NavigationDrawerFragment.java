...
import com.Mezda.Catastro.activity.ChangePasswordActivity;
import com.Mezda.Catastro.activity.ProfileUpdateActivity;
import com.Mezda.Catastro.adapter.NavigationAdapter;

import static com.Mezda.Catastro.util.Constants.URL_FACEBOOK;
import static com.Mezda.Catastro.util.Constants.URL_GOOGLE_PLUS;
import static com.Mezda.Catastro.util.Constants.URL_LINKEDIN;
import static com.Mezda.Catastro.util.Constants.URL_TWITTER;
import static com.Mezda.Catastro.util.Constants.URL_YOUTUBE;
...
import static com.Mezda.Catastro.util.UtilMethods.showExitDialog;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        navigationListView.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                if (groupPosition == 2){
                    startActivity(new Intent(getActivity(), ResultListFragmentqr.class));
                    closeDrawer();
                }

                if (isUserSignedIn(getActivity()) && groupPosition == 3) { //MAPAS
                    closeDrawer();
                    startActivity(new Intent(getActivity(), OfflineManagerActivity.class));

                }

                if (isUserSignedIn(getActivity()) && groupPosition == 4) {//CERRAR SESION
                    closeDrawer();
