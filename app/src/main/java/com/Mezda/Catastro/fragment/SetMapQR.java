...
public class SetMapQR extends AppCompatActivity implements PermissionsListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_set_maptoqr);
  ...
  /*  bt = (Button) findViewById(R.id.btn_set_dir);
    ...
    IconFactory iconFactory = IconFactory.getInstance(SetMapQR.this);
    ...
    mapView.getMapAsync(new OnMapReadyCallback() {
      ...
      public void onMapReady(MapboxMap mapboxMap) {
        ...
        // setInitialCamera.
        permissionsManager = new PermissionsManager(SetMapQR.this);
        if (!PermissionsManager.areLocationPermissionsGranted(SetMapQR.this)) {
          permissionsManager.requestLocationPermissions(SetMapQR.this);
        } else {
          // setInitialCamera();
        }
   ...
   // vgp = (ImageView)findViewById(R.id.img_origen);
    ...
    selectLocationButton.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        DetailViewFragment.UpdateGPS(Lat,Lng);
  ...
  private void setInitialCamera() {
    ...
    locationListener = new LocationEngineListener() {
      ...
      public void onConnected() {
        if (ActivityCompat.checkSelfPermission(SetMapQR.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(SetMapQR.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
