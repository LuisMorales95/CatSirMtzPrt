...
import com.Mezda.Catastro.adapter.SubCategoryAdapter;
...
import static com.Mezda.Catastro.util.Constants.JF_DATA;
    ...
    private void initSubCategoryList() {
        ...
        try {
            ...
            for (int i = 0; i < categoryArray.length(); i++) {
                ...
                category.setId(categoryArray.getJSONObject(i).getString(SP_ID));
