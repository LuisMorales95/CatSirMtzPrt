 ...
 */
public class FloatLabelStatic extends FrameLayout {
    ...
    public FloatLabelStatic(Context context) {
        this(context, null, 0);
    }

    public FloatLabelStatic(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FloatLabelStatic(Context context, AttributeSet attrs, int defStyle) {
