...
import com.Mezda.Catastro.activity.SignInActivity;

import java.io.IOException;
import java.io.InputStream;

import static com.Mezda.Catastro.util.Constants.FINDER_HOTLINE;
...
public class UtilMethods {
    ...
    public static boolean isUserSignedIn(Context context) {
        if (!TextUtils.isEmpty(getPreferenceString(context, Const.SP_token))) {
            return true;
        } else {
            return false;
        }
    ...
    public static void deleteUser(Context context) {
        savePreference(context, Const.SP_token, "");
        savePreference(context, Const.SP_idbrigada, "");
        savePreference(context, Const.SP_idpersona, "");
        savePreference(context, Const.SP_user, "");
        savePreference(context, Const.SP_Links, "");
        context.deleteDatabase(MyBase.NOMBRE_BASEDATOS);
        context.deleteDatabase(MyBase2.NOMBRE_BASEDATOS);
        context.deleteDatabase(MyBase3.NOMBRE_BASEDATOS);
        context.deleteDatabase(MyBaseL.NOMBRE_BASEDATOS);
    }
